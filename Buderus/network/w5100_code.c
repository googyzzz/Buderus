...
int main(void) {
    ...
    // Loop forever
    for (;;) {
        sockstat = W5100_Read(S0_SR);     // read Socket status
        switch (sockstat) {
        case SOCK_CLOSED:
...
//                    strcat_P((char *) buf,
//                            PSTR("<h1>Embedded Web Server</h1>\r\n"));
//                    strcat_P((char *) buf,
//                            PSTR("<h3>AVRJazz Mega328 and WIZ811MJ</h3>\r\n"));
//                    strcat_P((char *) buf,
//                            PSTR("<p><form method=\"POST\">\r\n"));
//                    // Now Send the HTTP Response
...
//                    strcpy_P((char *) buf,
//                            PSTR(
//                                    "<strong>Temp: <input type=\"text\" size=2 value=\""));
...
/////////////////// webserver auf 192.168.0.15 antwortet mit HTML code /////////
